...
"""
The Properties class is the object for xxx=xxx conf file
"""
...
class Properties(object):
    ...
    def setProperty(self, rkey, rvalue):
    ...
    def __delitem__(self, item):
        s_item = str(item)
        if self._origprops.has_key(s_item):
            del self._origprops[s_item]
        if self._keymap.has_key(s_item):
            del self._keymap[s_item]
